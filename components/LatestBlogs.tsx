      ...
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="flex justify-between items-center mb-12">
          <h2 className="text-3xl md:text-5xl font-bold text-white uppercase tracking-tighter">
            Popular Trading <span className="text-emerald-500">Articles</span>
          </h2>
          <Link
            href="/blog"
            className="bg-emerald-500 hover:bg-emerald-600 text-slate-950 px-8 py-2.5 rounded-xl font-bold transition-all hover:scale-105 active:scale-95 shadow-lg shadow-emerald-500/20"
          >
            View All
          </Link>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {blogs.map((blog: IBlog) => (
            ...
            >
              ...
              <h3 className="text-2xl font-bold text-white mb-3 group-hover:text-emerald-500 transition-colors leading-tight">
                {blog.title}.
              </h3>
              ...
              <Link
                href={`/blog/${blog._id}`}
                className="text-emerald-500 font-bold flex items-center gap-2 hover:gap-3 transition-all text-sm group/link"
              >
                Read More
